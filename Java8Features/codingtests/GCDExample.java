 ...
 * two numbers using Euclid’s method. There are other methods as well to * find
 * GCD of two number in Java but this example of finding GCD of two number * is
 * most simple. * * @author Javin Paul
 */
