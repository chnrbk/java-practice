...
public class MissingNumberInArray {
    ...
    public static void main(String args[]) {
        ...
        // one missing number
        printMissingNumber(new int[]{3, 6, 5, 4, 8}, 6);
...
//Read more: https://javarevisited.blogspot.com/2014/11/how-to-find-missing-number-on-integer-array-java.html#ixzz5gPfPwhNY